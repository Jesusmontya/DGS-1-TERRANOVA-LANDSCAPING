...
type PageProps = {
  ...
  showSiteChrome?: boolean; photos?: string[]
}
...
export default function CommercialServicePage({ canonical, serviceName, eyebrow, title, intro, photoAlt, tags, features, faqs, related, showSiteChrome = false, photos = realPhotos }: PageProps) {
  const serviceSchema = {

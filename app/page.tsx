...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="cta-section" id="contact"><div className="page-width cta-inner"><div><p className="eyebrow light">READY WHEN YOU ARE</p><h2>Tell us what you want to build.</h2><p>Send the basics about your project. TerraNova can review the request, contact you, and help determine the next step for design and pricing.</p><div className="cta-contact-links"><a href="tel:+17758707224" onClick={() => handlePhoneClick('contact_section')}>Call 775-870-7224 <span>↗</span></a><a href="mailto:info@terranovalandscapingnv.com">Email us <span>↗</span></a></div></div><form id="quote-form" className="lead-form" onSubmit={async (e) => {
        e.preventDefault()
